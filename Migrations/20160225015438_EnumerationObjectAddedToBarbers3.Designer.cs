...
namespace WaitlistManager.Migrations
{
    ...
    [Migration("20160225015438_EnumerationObjectAddedToBarbers3")]
    partial class EnumerationObjectAddedToBarbers3
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("WaitlistManager.Models.Barber", b =>
                {
                    b.HasOne("WaitlistManager.Models.Visit")
                        .WithMany()
                        .HasForeignKey("VisitVisitId");
                });
        }
    }
}
